...
//        easy to use with different browsers, finds driver path automatically
//
...
//        driver = new ChromeDriver(new ChromeOptions().setHeadless(true)); //chrome acmadan test ediyor
