...
//        assertion
     ...
     * -element locator may be dynamic(dynamic id)  (how to handle dynamic id?  -> 3 ways: use contains, starts with, ends with)
     ...
     *
     *
     * implicit wait can not catch performance issues, explicit wait does.
     * implicit waits until finds each element (checks each element one by one)--> effects the  execution speed
     * since explicit is element-specific, it may be faster
     *
     *
     * */
