...
//        1. Create Actions class
        Actions actions = new Actions(driver);  // use driver as paarmeter so Action class can control the driver

//        2. use actions method that is needed
//      When use Right clicks on the box
        actions.contextClick(rectangle).perform();  // perform --> is used to execute the action method
//    Then verify the alert message is “You selected a context menu”
