...
public class Day09_Screenshots extends TestBase {
     ...
     * -I have a reusable method in my utilities package. I use that method.
...
//    It is important to take screenshots for documentation
//    We must take screenshots as a proof of test result.
//    We can automate taking screenshot with selenium  --> if fails take screenshot  else don't take
...
//        getting the current time for unique name
        ...
        // eger bunu yapmazsak keep overriding the previous one

        String currentTime = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date()); // "yyyy-MM-dd-hh:mm:ss"
        System.out.println(currentTime);

//        path of the saved image
        String path  = System.getProperty("user.dir")+"/test-output/Screenshots/"+currentTime+".png";
        System.out.println(System.getProperty("user.dir"));
        //C:\Users\cetin\IdeaProjects\myseleniumproject\test-output\Screenshots

        File finalPath =  new File(path); // saving the file on the computer
